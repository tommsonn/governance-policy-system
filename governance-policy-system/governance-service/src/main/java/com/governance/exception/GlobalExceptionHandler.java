...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidPolicyStatusTransitionException.class)
    public ResponseEntity<ErrorResponse> handleInvalidStatusTransition(InvalidPolicyStatusTransitionException ex) {
